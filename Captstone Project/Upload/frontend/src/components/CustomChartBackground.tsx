...
import { AxisScale, DataContext, DataContextType } from '@visx/xychart';

const patternId = 'xy-chart-pattern';

export default function CustomChartBackground() {
  const { theme, margin, width, height, innerWidth, innerHeight } = useContext<DataContextType<AxisScale, AxisScale, object>>(DataContext);
